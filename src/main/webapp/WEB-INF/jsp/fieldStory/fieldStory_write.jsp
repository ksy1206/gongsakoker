...
$(document).ready(function (){
	...
	$("#confirms").click(function(){
		document.fieldStoryWrite.action = '<%=cp%>/fieldStory/fieldStory_write.do';
...
// 		alert(file_hidden);
		...
		if(file!=""){//미리보기일 경우
			$("#img_preview"+(file_no).substring(9, 10)).attr("src", file_src);
			$("#area_img0"+(file_no).substring(9, 10)).val("");
			
		} else {//이미 저장된 파일일 경우
// 			if(chk_file=="Y"){
				
// 				params = "member_no="+"&file_no="+file_no;
...
<div data-role="page" class="board_page" style="background-color:#e9e9e9 !important;">
	...
	<div data-role="content" class="area_board_content" style="background-color:#fff; margin-bottom:0;">			
		<div class="ui-grid-b"> 
		...
		<div class="ui-grid-a" class="" style="border:none;"> 
	    	<div class="ui-block-a">
				<p>내용</p> 
			</div>
	    	<div class="ui-block-b">
	...
	<div class="write_field" style="padding:.5em .7em;">
		<div class="ui-grid-b" style="border:solid 1px #29A9C8; background-color:#fff; padding: 0 .2em;"> 
		    ...
		    <div class="ui-block-a" style="text-align:center; padding:0 .3em; position:relative;">
				...
				<img src='../img/member_set/member_img_plus.jpg' style="width:100%;"  border='0' id="img_preview1" accept="image/*" capture="camera" onclick='document.getElementById("area_img01").click();'>
		    ...
		    <div class="ui-block-b" style="text-align:center; padding:0 .3em; position:relative;">
				...
				<img src='../img/member_set/member_img_plus.jpg' style="width:100%;"  border='0' id="img_preview2" onclick='document.getElementById("area_img02").click();'>
		    ...
		    <div class="ui-block-c" style="text-align:center; padding:0 .3em; position:relative;">	
				...
				<img src='../img/member_set/member_img_plus.jpg' style="width:100%;" border='0' id="img_preview3" onclick='document.getElementById("area_img03").click();'>
	...
	<div data-role="footer" data-position="fixed" class="guide_footer" style="border:none;">
		<div>
			<input type="button" value="등록하기" id="write_fieldStroy">
		</div>
	</div>		
